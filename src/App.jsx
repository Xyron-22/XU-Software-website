  ...
  return (
    <>
      <div className='text-white flex flex-col items-center min-h-[80vh]'>
        ...
        <section className='w-full min-h-[50vh] bg-[#222b3c] flex flex-col items-center p-4 bg-gradient-to-t from-black' id='about'>
          <h1 className='text-center m-4 mt-10 text-2xl md:text-4xl font-bold'>About Us</h1>
        ...
        <section className='w-full h-[86vh] bg-white'>
          <h1 className='text-center m-4 mt-10 text-2xl md:text-4xl font-bold text-black'>Developers</h1>
        </section>
      </div>
    </>
  )
